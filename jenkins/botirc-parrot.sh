...
WORGING_DIR_IN_GIT='miscellaneous/debpkg_botirc-parrot/botirc-parrot'
VERSION="$(date '+%Y%m%d%H%M')" # Attention, this is a native package so no `-' in the version number.
