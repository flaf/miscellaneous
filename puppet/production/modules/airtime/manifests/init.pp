...
#   class will automatically include the "icecast2" class in the
#   good moment to avoid ordering errors.
#   And see the documentation of the icecast2 puppet class
#   because maybe you will must finish the installation manually.
#
#
#==Hiera
#
